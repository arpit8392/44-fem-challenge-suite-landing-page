...
const Hero = () => {
	return (
		<div className='grid grid-cols-1 gap-14 mt-8 mb-56 md:mb-72 lg:mb-56 lg:grid-cols-6 lg:gap-24'>
			...
			<ul className='flex flex-col items-center text-center gap-8 md:flex-row md:justify-evenly lg:col-auto lg:flex-col lg:text-left lg:items-start lg:gap-16 md:mt-40 lg:mt-28'>
				{metrics.map((metric) => (
					<li key={metric.title}>
